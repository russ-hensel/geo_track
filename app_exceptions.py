...
class DBOjectException( ApplicationError ):
    ...
    this is for early return to terminate a function ususlly because of bad
    file name, file contents.... msg should eluicadate
...
def get_execpt_traceback( print_flag = True ):
    ...
    ret_string   = f"-------- get_execpt_traceback()  -------------\n\n{a_join}"
