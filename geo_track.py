...
class App( app_abc.AppABC ):
    ...
    def _finish_gui(self ):
        ...
        if   self.parameters.gui_module  == "gui_with_tabs":
            ...
            # self.gui.run( polling_function = self.a_test_polling_function)   #
            self.gui.run( polling_function = self._polling_task )

            msg       = "in App: .... polling_function done"
            print( msg )
    ...
    #        self.logger.info( "new_clip = " +  new_clip_b  )
            #rint( "no app history for now")
            #rint( "need to reinstate history see gui_with_tabs")
    ...
    def input_and_go( self,  ):
        ...
        try:
            ...
            # ---- "PhotoPoints"
                ...
                print( f"input_and_go unreconized option {option }")
   ...
   # --------------------------
    ...
    def get_date_filter_function( self,  ):
        ...
        msg          = "nget_date_filter_function  eed to error check start and end date here "
        print( msg )
        ...
        msg               = "filter on dates  {start_datetime}     to  {end_datetime} "
        print( msg )
        AppGlobal.gui.write_gui( msg )
